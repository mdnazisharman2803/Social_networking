  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: 'AIzaSyB45oeAz_HUKz_94zGFyeFt9TuH_cmcdhE',
        appId: '1:971141345607:web:2d90ece3437895d57e1c62',
        messagingSenderId: '971141345607',
        projectId: 'weconnects-e5a9a',
        storageBucket: 'weconnects-e5a9a.appspot.com',
      ),
    );
  } else {
    await Firebase.initializeApp();
